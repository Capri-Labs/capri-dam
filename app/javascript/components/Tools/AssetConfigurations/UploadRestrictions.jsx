...
const COMMON_MIME_SUGGESTIONS = [
    ...
    { label: 'Illustrator (AI)', value: 'application/illustrator' },
    { label: 'InDesign (INDD)', value: 'application/x-adobe-indesign' },
    { label: 'EPS', value: 'application/postscript' },
    { label: 'Adobe XD', value: 'application/vnd.adobe.xd' },
    { label: 'Figma (.fig)', value: 'application/x-figma' },
    { label: 'Sketch', value: 'application/x-sketch' },
    { label: 'Camera RAW (Canon)', value: 'image/x-raw-canon' },
    { label: 'Camera RAW (Nikon)', value: 'image/x-raw-nikon' },
    { label: 'Camera RAW (Sony)', value: 'image/x-raw-sony' },
    { label: 'Camera RAW (Adobe DNG)', value: 'image/x-raw-adobe' },
    ...
    { label: 'Keynote', value: 'application/vnd.apple.keynote' },
    { label: 'Pages', value: 'application/vnd.apple.pages' },
